...
void specialFunc( int key, int x, int y )
{
    ...
    {
    case GLUT_KEY_UP:
        // increase light2 by .5
		light2 += .5;
		break;
    case GLUT_KEY_DOWN:
        // decrease light2 by .5
		light2 -= .5;
		break;
    case GLUT_KEY_LEFT:
        // decrease light1 by .5
		light1 -= .5;
		break;
    case GLUT_KEY_RIGHT:
        // increase light1 by .5
		light1 += .5;
		break;
    }
...
void drawScene(void)
{
    ...
    // Light position
	GLfloat Lt0pos[] = {light1, light2, 5.0f, 1.0f};
...
void loadInput()
{
    ...
    while(cin.getline(buffer, MAX_BUFFER_SIZE))
    {
        ...
        else if(s == "f")
        {
            ...
            ss >> a >> tmp >> b >> tmp >> c >> d >> tmp >> e >> tmp >> 
            f >> g >> tmp >> h >> tmp >> i;

            //cout << a << " " << b << " " << c << " " << d << " " << e << " " << f << " " <<
            //g << " " << h << " " << i << endl;

            vec.insert(vec.end(), {c,a,f,d,i,g});
